        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`badge ${
              autoMappingResult.confidence >= 0.8 ? 'badge-success' :
              autoMappingResult.confidence >= 0.6 ? 'badge-warning' : 'badge-error'
            }`}>
            ...
            <table className="w-full">
              ...
              <tbody>
                {detectedHeaders.map((sourceHeader) => {
                  ...
                  const targetField = selectedTemplate.fields.find(f => f.target === currentMapping);
                  const autoMatch = autoMappingResult?.matches.find(m => m.sourceHeader === sourceHeader);
