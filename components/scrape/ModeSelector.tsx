...
const modes: Mode[] = [
  ...
  },
  {
    ...
    description: 'Extract player statistics, biographical data, and achievements from sports reference sites',
    icon: '🏈',
                ...
                <div className="text-xs text-gray-400">
                  ...
                  <div className="space-y-1">
                    {mode.examples.slice(0, 2).map((example, idx) => (
                      <div
                        key={idx}
                        className="truncate font-mono bg-gray-50 px-2 py-1 rounded"
                      >
                        {example}
                      </div>
                    ))}
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong>News Articles:</strong> Best for extracting article content, titles, authors, and publication dates
                </li>
                <li>
                  <strong>Sports Statistics:</strong> Specialized for Pro Football Reference and similar sports sites
                </li>
                <li>
                  <strong>Supplier Directory:</strong> Optimized for business directories with pagination support
                </li>
              </ul>
            </div>
          </div>
