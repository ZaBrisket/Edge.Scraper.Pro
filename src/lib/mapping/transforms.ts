...
const logger = createLogger('transforms');
...
export const transforms: Record<string, TransformFunction> = {
  ...
  removeCompanyDesignators: (value: any) => {
    if (typeof value !== 'string') return value;
 ...
 */
export function applyTransform(transformName: string, value: any): any {
 ...
 */
export function applyTransforms(transformNames: string[], value: any): any {
...
export function transformRow(
  ...
  fieldDefs: Array<{ targetField: string; transform?: string; defaultValue?: string }>
): Record<string, any> {
 ...
 */
export function validateTransforms(transformNames: string[]): {
  valid: string[];
  invalid: string[];
} {
  const valid: string[] = [];
