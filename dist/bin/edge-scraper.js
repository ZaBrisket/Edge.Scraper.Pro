...
const index_1 = require("../exporters/trivia_v1/index");
// Import batch processor and extractors
const batch_processor_1 = require("../lib/batch-processor");
const supplier_directory_test_suite_1 = require("../lib/supplier-directory-test-suite");
// @ts-ignore - JavaScript module without types
const supplier_export_1 = require("../lib/supplier-export");
...
program
    ...
    try {
        ...
        // Run export
        await (0, index_1.exportTriviaDataset)(inputPath, outputPath, exportOptions);
...
program
    ...
    try {
        ...
        const exporter = new supplier_export_1.SupplierDataExporter();
...
program
    ...
    try {
        ...
        const testSuite = new supplier_directory_test_suite_1.SupplierDirectoryTestSuite();
...
program.parse();
//# sourceMappingURL=edge-scraper.js.map